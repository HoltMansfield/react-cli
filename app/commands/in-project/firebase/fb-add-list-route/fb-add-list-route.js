...
const fbAddListRoute = async (collectionName) => {
  ...
  const url = `list${strings.capitalizeFirstLetter(collectionTemplateData.collectionName)}`
  // map template data
  ...
  if (hasUseCollection) {
    ...
    await fbAddList(collectionName)
  }
}
