...
const fbAddEditRoute = async (collectionName) => {
  ...
  const url = `edit-${collectionTemplateData.collectionNameSingular}/:id`
  const fileName = `${collectionTemplateData.collectionNameSingularPascalCase}Edit`
  ...
  if (hasUseCollection) {
    ...
    await fbAddEdit(collectionName)
  }
}
